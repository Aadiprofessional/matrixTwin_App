...
export type AppStackParamList = {
  ...
  Diary: { projectId: string; projectName: string; initialFormId?: string };
  Safety: { projectId: string; projectName: string; initialFormId?: string };
  Labour: { projectId: string; projectName: string; initialFormId?: string };

...
const ACCENT = '#4f46e5';
const WORKS_CATEGORIES = ['General', 'Concrete', 'Steel', 'Plumbing', 'Electrical', 'Finishing'];
    ...
    <Modal visible={visible} animationType="slide" transparent>
      <View style={S.overlay}>
        <View style={S.sheet}>
          <View style={S.header}>
            <View>
              <Text style={S.headerTitle}>Inspection Check Form</Text>
          ...
          <View style={S.tabRow}>
            {['Request', 'Inspection', 'Outcome'].map((t, i) => (
          ...
          <ScrollView style={S.body} showsVerticalScrollIndicator={false}>
            ...
            {page === 1 && (
              <View>
                ...
                <TRow label="Works to be Inspected *">
                  <TextInput style={[S.input, S.ta]} value={form.worksToBeInspected} onChangeText={v => set('worksToBeInspected', v)} placeholder="Describe works to be inspected..." placeholderTextColor={colors.textMuted} multiline numberOfLines={3} />
                </TRow>
            ...
            {/* PAGE 2: Inspection Scheduling */}
            {page === 2 && (
              <View>
                <Text style={S.sectionTitle}>Requested Inspection</Text>
                <View style={{ flexDirection: 'row', gap: spacing.sm }}>
                  <View style={{ flex: 1 }}>
                    <TRow label="Date">
                ...
                <TRow label="General Cleaning">
                  <TextInput style={S.input} value={form.generalCleaning} onChangeText={v => set('generalCleaning', v)} placeholder="General cleaning done?" placeholderTextColor={colors.textMuted} />
                </TRow>
            ...
            {page === 3 && (
              <View>
                <Text style={S.sectionTitle}>Inspection Outcome</Text>
                <TRow label="Inspected By">
                  <TextInput style={S.input} value={form.inspectedBy} onChangeText={v => set('inspectedBy', v)} placeholder="Inspector name" placeholderTextColor={colors.textMuted} />
                </TRow>
                <TRow label="Inspected At">
                  <TextInput style={S.input} value={form.inspectedAt} onChangeText={v => set('inspectedAt', v)} placeholder="Location / area" placeholderTextColor={colors.textMuted} />
                </TRow>
                <View style={S.switchRow}>
                  <View style={{ flex: 1 }}>
                    <Text style={S.switchLabel}>No Objection</Text>
                    <Text style={S.switchSub}>Works can proceed</Text>
                  </View>
                  <Switch value={form.noObjection} onValueChange={v => set('noObjection', v)} thumbColor={form.noObjection ? '#22c55e' : '#888'} trackColor={{ true: '#22c55e44', false: '#33333' }} />
                </View>
                <View style={S.switchRow}>
                  <View style={{ flex: 1 }}>
                    <Text style={S.switchLabel}>Deficiencies Noted</Text>
                    <Text style={S.switchSub}>Works need correction</Text>
                  </View>
